...
class Block_port(Responder):
    def __init__(self):
        ...
        self.name_security_rule = self.get_param(
            "config.Security_rule_for_blocking_port_internal_communication",
            "TheHive Block port for internal communication",
        )
    ...
    def run(self):
        ...
        self.report(
            {
                "message": "Responder successfully added %s into TheHive Block list for internal port communication from %s"
