...
class UmbrellaAnalyzer(Analyzer):
    def __init__(self):
        ...
        self.api_secret = self.get_param(
            "config.api_secret", None, "api_secret is missing"
        )
        self.organization_id = self.get_param(
            "config.organization_id", None, "organization_id is missing"
        )
