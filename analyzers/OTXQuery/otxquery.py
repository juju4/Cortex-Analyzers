...
class OTXQueryAnalyzer(Analyzer):
    ...
    def _get_headers(self):
        return {"X-OTX-API-KEY": self.otx_key, "Accept": "application/json"}
    ...
    def otx_query_domain(self, data):
        ...
        try:
            ...
            result = {
                "pulse_count": ip_.get("general", {})
                .get("pulse_info", {})
                .get("count", "0"),
                "pulses": ip_.get("general", {})
                .get("pulse_info", {})
                .get("pulses", "-"),
        ...
        try:
            ...
            if ip_["analysis"]["analysis"]:
                ...
                result = {
                    ...
                    "sha1": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("sha1", "-"),
                    "sha256": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("sha256", "-"),
                    "md5": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("md5", "-"),
                    "file_class": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("file_class", "-"),
                    "file_type": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("file_type", "-"),
                    "filesize": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("filesize", "-"),
                    "ssdeep": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("info", {})
                    .get("results", {})
                    .get("ssdeep"),
                    "combined_score": ip_.get("analysis", {})
                    .get("analysis", {})
                    .get("plugins", {})
                    .get("cuckoo", {})
                    .get("result", {})
    ...
    def summary(self, raw):
        ...
        if "combined_score" in raw:
            ...
            value = (
                "Number of pulses: "
                + value
                + ", Pulses that have a malicious tag: "
                + str(malicious_count)
            )
            taxonomies.append(self.build_taxonomy(level, namespace, predicate, value))
