...
class ValidateObservable(Analyzer):
    ...
    def validate_ip(self, ip):
        try:
            if "/" in ip:  # CIDR range
                ...
                return {"status": "valid", "type": "IP range", "value": ip}
            else:  # Single IP
                ...
                if ip_obj.is_loopback:
                    ...
                    return {"status": "valid", "type": "IP address", "value": ip}
        except ValueError:
            return {"status": "invalid", "type": "IP address", "value": ip}
    ...
    def validate_domain(self, domain):
        try:
            ...
            if re.match(domain_regex, punycode_domain):
                ...
                return {"status": "valid", "type": "Domain", "value": domain}
            else:
                return {"status": "invalid", "type": "Domain", "value": domain}
    ...
    def validate_url(self, url):
        ...
        if all([parsed.scheme, parsed.netloc]):
            ...
            return {"status": "valid", "type": "URL", "value": url}
        return {
            "status": "invalid",
            "type": "URL",
            "value": url,
    ...
    def validate_fqdn(self, fqdn):
        ...
        if re.match(fqdn_regex, fqdn):
            ...
            return {"status": "valid", "type": "FQDN", "value": fqdn}
        else:
            return {"status": "invalid", "type": "FQDN", "value": fqdn}
    ...
    def validate_email(self, email):
        ...
        if re.match(email_regex, email):
            ...
            return {"status": "valid", "type": "Email", "value": email}
        else:
            return {"status": "invalid", "type": "Email", "value": email}
    ...
    def validate_filename(self, filename):
        ...
        return {"status": "valid", "type": "Filename", "value": filename}

    def validate_uri_path(self, uri_path):
        parsed = urlparse(uri_path)
        if parsed.path and parsed.path.startswith("/"):
            return {"status": "valid", "type": "URI Path", "value": uri_path}
        return {
            "status": "invalid",
            "type": "URI Path",
            "value": uri_path,
    ...
    def validate_user_agent(self, user_agent):
        ...
        return {"status": "valid", "type": "User-Agent", "value": user_agent}
