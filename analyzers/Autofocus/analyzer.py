...
class SearchJson_IP(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [
                {"field": "alias.ip_address", "operator": "contains", "value": value}
            ],
        }
...
class SearchJson_Domain(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [
                {"field": "alias.domain", "operator": "contains", "value": value}
            ],
        }
...
class SearchJson_TAG(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [
                {"field": "sample.tag", "operator": "is in the list", "value": [value]}
            ],
        }
...
class SearchJson_Imphash(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [{"field": "sample.imphash", "operator": "is", "value": value}],
        }
...
class SearchJson_Mutex(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [
                {"field": "sample.tasks.mutex", "operator": "contains", "value": value}
            ],
        }
...
class SearchJson_UserAgent(SearchJson):
    def __init__(self, value):
        self.search = {
            "operator": "all",
            "children": [
                {"field": "alias.user_agent", "operator": "contains", "value": value}
            ],
        }
